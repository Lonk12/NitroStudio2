        ...
        public override void Read(FileReader r) {
            ...
            for (uint i = 0; i < numWaves; i++) {
                ...
                if (r.ReadBoolean()) {
                    ...
                    Waves[^1].Wave = (Wave)r.ReadFile<Wave>();
                }
            }
        ...
        public void WriteInstrument(Bank bnk, int instrumentId, SoundArchive a, ushort war0, ushort war1, ushort war2, ushort war3) {
            ...
            foreach (var r in Inst.NoteInfo) {
                ...
                if (!found) {
                    ...
                    WaveMapper mapper = new(new List<RiffWave>() { riff }, wars.Where(x => x != null).ToList(), true)
                    {
                        MinimizeBox = false
                    };
                    mapper.ShowDialog();
                    ...
                    r.WaveId = (ushort)(a.WaveArchives.FirstOrDefault(x => x.Index == mapper.WarMap[0]).File.Waves.Count - 1);
